pipeline {
    ...
    environment {
        ...
        ARTIFACTORY_REPO = 'http://54.80.16.163:8081/repository/carbon-docker-hosted/v2/'
        ...
        stage('Push Container Image to Artifactory') {
            steps {
                script {
                    ...
                    sh """
                        docker login ${ARTIFACTORY_REPO} -u ${ARTIFACTORY_USERNAME} --password-stdin ${ARTIFACTORY_PASSWORD}
